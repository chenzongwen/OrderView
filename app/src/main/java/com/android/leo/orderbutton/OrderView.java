...
import com.android.leo.orderbutton.util.Utils;
...
public class OrderView extends View {
        ...
        switch (mCurrentState) {
            ...
            case STATE_TEXT_EXPAND:
                ...
                if (mCurrentState == STATE_NORMAL) {
                    ...
                    int textX = mWidth / 2;
                    int textY = mHeight / 2 + Utils.getInstance().getTextHeight(textContent, mPaintText) / 2;
                    canvas.drawText(textContent, textX, textY, mPaintText);
                    mPaintText.setTextSize(mPaintText.getTextSize() * 2);
                }
                break;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mWidth = Utils.getInstance().getTextWidth(mPaintText, textContent) / 5 * 6;
        mHeight = Utils.getInstance().sp2px(getContext(), 16) * 2;
